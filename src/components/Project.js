...
export default function Project(props) {
    return (
        <div className="col-md-6">
            <a href={props.project} alt={props.projectAlt}><img style={{ "marginBottom":"5px", "border":"5px solid #a8dadc","borderRadius":"3px","opacity":"1","width":"375px" }} src={props.img} alt={props.imgAlt}></img></a>
